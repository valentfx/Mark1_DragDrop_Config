...
/* Read File
 *
 * The file read/write pointer of the file object advances number of bytes read. After the function succeeded,
 * *ByteRead should be checked to detect the end of file.
 * In case of *ByteRead < ByteToRead, it means the read/write pointer reached end of the file during read operation.
 *
/*-----------------------------------------------------------------------*/
